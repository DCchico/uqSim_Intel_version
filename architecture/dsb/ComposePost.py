...
def main():
	...
	recvTm = march.make_time_model("expo", [1500])
	respTm = None
	socket_stage = march.make_stage(stage_name = "socket", pathId = 0, pathStageId = 1, stageId = 1, blocking = True, batching = True, socket = True, 
	...
	respTm = None
	proc_stage = march.make_stage(stage_name = "proc", pathId = 0, pathStageId = 2, stageId = 2, blocking = False, batching = False, socket = False, 
		epoll = False, ngx = False,  net = True, chunk = False, recvTm = recvTm, respTm = respTm, cm = None, criSec = False, threadLimit = None, 
		scaleFactor = 0.4)

	req_path = march.make_code_path(pathId = 0, prob = 100, stages= [epoll_stage, socket_stage, proc_stage], priority = None)
	...
	# compose_post
	comp = march.make_micro_service(servType = "micro_service", servName = "compose_post", bindConn = True, paths = [req_path], 
