...
def main():
	...
	# read_home_t
	comp = march.make_micro_service(servType = "micro_service", servName = "read_home_t", bindConn = True, paths = [req_path], 
		baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/read_home_t.json", "w+") as f:
