...
def main():
	...
	# rabbit_mq
	comp = march.make_micro_service(servType = "micro_service", servName = "rabbit_mq", bindConn = True, paths = [req_path], 
		baseFreq = 2600, curFreq = 2600)

	with open("./json/microservice/rabbit_mq.json", "w+") as f:
